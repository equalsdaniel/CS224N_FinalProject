...
Original file is located at
    https://colab.research.google.com/drive/1u85NW9yV_gXYA-wKZKTyct1XNBxUFTjj

## **Warm-starting BERT2BERT**

> Indented block



***Note***: This notebook is taken from Microsoft NLP-Recipes. We used two different Datasets. In this version, we used the PubMed dataset.
...
# #!pip uninstall dill=0.3.5.1
# !pip install dill==0.3.4
# !pip install -U datasets
# 
# ! git lfs install
# ! git clone https://huggingface.co/datasets/scientific_papers
# 
# import datasets
# import transformers
...
#!pip install --no-deps --force-reinstall dill==0.3.5.1
#!pip install --upgrade --no-deps --force-reinstall datasets

batch_size=4  # change to 16 for full training #or 4
...
test_data = datasets.load_dataset("scientific_papers", 'pubmed', split="validation")
